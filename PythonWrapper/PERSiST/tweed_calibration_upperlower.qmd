# PERSiST hydrological model

This is based on the Tarland example calibration, for the Tweed. Splits the Tweed into an 'upper' and 'lower' catchment. This version merges uses a linked model of Upper Tweed flowing into Lower.
...
#params_path = "/home/nras/Mobius/tweed_persist/BasinObs_upper_testparameters.dat"
#inputs_path = "/home/nras/Mobius/tweed_persist/BasinObs_upper_datainputs.dat"
...
```{python}
#| echo: false
index_short_name = {'All':'A', 'Quick':'q', 'Soilwater':'s', 'Groundwater':'g', 'UpperTweed':'ru', 'LowerTweed':'rl'}
...
```{python}
#| echo: false
optimized_params = "/home/nras/Mobius/PythonWrapper/PERSiST/optimized_params.dat"
os.environ['OPTIMIZED'] = optimized_params
os.environ['INPUTS_PATH'] = inputs_path

!cd /home/nras/Mobius && python /home/nras/Mobius/PythonWrapper/PERSiST/persist_calib_uncert.py
```
