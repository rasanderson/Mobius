...
This is based on the Tarland example calibration, for the Lower Tweed. Splits the Tweed into an 'upper' and 'lower' catchment.
...
params_path = os.path.join(two_dirs_up, "tweed_persist", "BasinObs_lower_testparameters.dat")
inputs_path = os.path.join(two_dirs_up, "tweed_persist", "BasinObs_lower_datainputs.dat")
...
#| echo: false
comparisons = [
    ('Reach flow', ['LowerTweed'], 'observed Q', [])
]
```

```{python}
#| echo: false
index_short_name = {'All':'A', 'Quick':'q', 'Soilwater':'s', 'Groundwater':'g', 'LowerTweed':'r'}
