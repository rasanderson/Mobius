...
This is based on the Tarland example calibration, for the Tweed. Splits the Tweed into an 'upper' and 'lower' catchment.
...
params_path = os.path.join(two_dirs_up, "tweed_persist", "BasinObs_upper_testparameters.dat")
inputs_path = os.path.join(two_dirs_up, "tweed_persist", "BasinObs_upper_datainputs.dat")
