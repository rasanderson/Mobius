...
nsteps = 100   # Number of steps per chain              # Reset to 1000
nwalk = 10     # Number of chains/walkers               # Reset to 100
nburn = 50     # Number of steps to discard as burn-in  # Reset to 500
...
```{python}
#| echo: false
with open('/home/nras/Mobius/PythonWrapper/SimplyQ/results/mcmc_results.pkl', 'rb') as handle:
