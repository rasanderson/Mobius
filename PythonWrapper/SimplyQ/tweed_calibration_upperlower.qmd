...
params_path = os.path.join(two_dirs_up, "tweed_persist", "BasinObs_upperlower_testparameters.dat")
inputs_path = os.path.join(two_dirs_up, "tweed_persist", "BasinObs_upperlower_datainputs.dat")
...
#| echo: false
comparisons = [
    ('Reach flow', ['UpperTweed'], 'observed Q', ['UpperTweed']),
    ('Reach flow', ['LowerTweed'], 'observed Q', ['LowerTweed'])
]
```
...
!cd /home/nras/Mobius && python /home/nras/Mobius/PythonWrapper/SimplyQ/persist_calib_uncert.py
```
